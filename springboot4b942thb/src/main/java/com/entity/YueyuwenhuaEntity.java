...
public class YueyuwenhuaEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YueyuwenhuaEntity() {
		
	}
	
	public YueyuwenhuaEntity(T t) {
		try {
	 ...
	 * 设置：文化标题
	 */
	public void setWenhuabiaoti(String wenhuabiaoti) {
		this.wenhuabiaoti = wenhuabiaoti;
	}
	/**
	 * 获取：文化标题
	 */
	public String getWenhuabiaoti() {
		return wenhuabiaoti;
	}
	/**
	 * 设置：文化分类
